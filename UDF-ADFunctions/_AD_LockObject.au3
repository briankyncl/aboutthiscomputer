...
; *****************************************************************************
; Example 1
; Locks an AD object (user account, computer account).
; *****************************************************************************
#include <AD.au3>
...
Global $iReply = MsgBox(308, "Active Directory Functions - Example 1", "This script locks the specified object (user account, computer account)." & @CRLF & @CRLF & _
		"Are you sure you want to change the Active Directory?")
If $iReply <> 6 Then Exit

; Enter object to lock
